    ...
    <div className="w-4/5 pt-16 text-white border-b border-white mx-auto">
        <div className="max-w-[1240] mx-auto grid lg:grid-cols-3">
            <div className="lg:col-span-2 my-4 px-4">
                <h1 className="md:text-4xl sm:text-3xl text-2xl font-bold py-5">Lorem ipsum dolor sit, amet consectetur adipisicing.</h1>
            ...
            <div className='my-3'>
                ...
                <p className="px-4">Lorem ipsum dolor sit amet consectetur. <span className="text-[#00df9a]">Lorem, ipsum.</span></p>
            </div>
        </div>
    </div>
  )
